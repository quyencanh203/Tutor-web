...
INSERT INTO `users` (`name`, `email`, `password`, `avatar`, `sex`, `role`)
VALUES ('Admin', 'admin_tutor@gmail.com', '$2b$12$NJ/JabLpZDi/FYmJTYTWAeI6GQ0xjU30S9fDOkrpaGMGYMRjn9kmq', NULL, NULL, 'admin');

password: 123, vì mã hóa nên phải lưu ở dạng kia
*/